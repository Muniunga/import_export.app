                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>preco</label>
                                            <input type="text" class="form-control" name="preco" value="{{ old('id_pers') }}" required placeholder="Id personalizado">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="item_code" value="{{ old('quantidade') }}" required placeholder="Adicionar quantidade">
                                            <div style="color:red">{{ $errors->first('quantidade') }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
